...
fin_list("test1, test2, test3, test4, test5", int(input("Your number: ")))
...
def fin_list2(line, number):
    if number == "1":
        ...
        repl_line = "test" + number
    print(line.replace(repl_line, "").replace(", ,",","))
fin_list2("test1, test2, test3, test4, test5", input("Your number: "))
# task 2
...
def domain(url):
    ...
    print(work_list[0].replace("www.", ""))
domain("https://realpython.com/courses/python-thonny/")
